...
class InterviewScheduleEntity(Base):
  ...
  interview_time: Mapped[datetime] = mapped_column(DateTime(timezone=False), nullable=False)
  ...
  updated_at: Mapped[datetime] = mapped_column(
      DateTime(timezone=False), nullable=False, default=get_beijing_now_naive, onupdate=get_beijing_now_naive
  )
